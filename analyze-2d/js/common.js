...
const STEPS = [
  ...
  {id:"attributes", n:6, file:"6-attributes.html", title:"Attributes",       stage:null,
   blurb:"Twenty-two attributes, their correlation, and the striping check."},
  {id:"som",        n:7, file:"7-som.html",        title:"Self-organizing map", stage:null,
   blurb:"Unsupervised classes from a chosen set of attributes, with a null test."},
  {id:"shap",       n:8, file:"8-shap.html",       title:"SHAP",             stage:null,
   blurb:"Which attributes decide where each sample lands on the map."},
  {id:"refine",     n:9, file:"9-refine.html",   title:"Refine and compare", stage:null,
